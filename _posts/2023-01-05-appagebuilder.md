...
Be aware that version from 2.0.0 2.3.x+ (exact release is not determined) own another sql injection which will bypass your WAF (full base64) so you should upgrade asap to 2.4.5.
