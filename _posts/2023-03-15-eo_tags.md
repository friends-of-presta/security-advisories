...
This exploit uses cookies and referer manipulation, the attacker will be able to conceal the module name during the exploit, so you will never know within your conventional frontend logs that it exploits this vulnerability. **You will only see "GET /" or "POST /" inside your conventional frontend logs.**. The compromized referer will be visible in your access logs, however you'll not be able to see the compromized cookie.
