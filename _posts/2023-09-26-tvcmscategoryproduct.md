---
layout: post
title: "[CVE-2023-39647] Improper neutralization of SQL parameter in Theme Volty CMS Category Product module for PrestaShop"
categories: modules
author:
- TouchWeb.fr
- 202 Ecommerce
...
meta: "CVE,PrestaShop,theme volty,tvcmscategoryproduct"
severity: "critical (9.8)"
---

In the module "Theme Volty CMS Category Product" (tvcmscategoryproduct) up to version 4.0.1 from Theme Volty for PrestaShop, a guest can perform SQL injection in affected versions.


## Summary

* **CVE ID**: [CVE-2023-39647](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2023-39647)
* **Published at**: 2023-09-26
* **Platform**: PrestaShop
* **Product**: tvcmscategoryproduct
...
```diff
--- 4.0.1/tvcmscategoryproduct/ajax.php
+++ 4.0.2/tvcmscategoryproduct/ajax.php
...
* It’s recommended to upgrade to the latest version of the module **tvcmscategoryproduct**.
...
* [National Vulnerability Database](https://nvd.nist.gov/vuln/detail/CVE-2023-39647)
